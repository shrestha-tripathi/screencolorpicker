...
const STATIC_PAGES: SitemapEntry[] = [
  ...
  { path: "/hex-color-picker", changefreq: "weekly", priority: 0.9 },
  { path: "/rgb-color-picker", changefreq: "weekly", priority: 0.9 },
  { path: "/hsl-color-picker", changefreq: "weekly", priority: 0.9 },
  { path: "/color-picker-from-image", changefreq: "weekly", priority: 0.8 },
  { path: "/color-picker-without-extension", changefreq: "weekly", priority: 0.8 },
  { path: "/figma-color-picker-alternative", changefreq: "weekly", priority: 0.8 },
  { path: "/eyedropper-for-windows", changefreq: "weekly", priority: 0.8 },
  { path: "/eyedropper-for-mac", changefreq: "weekly", priority: 0.8 },
